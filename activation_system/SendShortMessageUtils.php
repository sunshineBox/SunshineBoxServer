...
class SendShortMessageUtils
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = "LTAIZonCRH8NpRW4"; // AccessKeyId

        $accessKeySecret = "qXoZv1we2EEHkxTpLUrVtMkh5vnDJK"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phoneNumbers, $templateParam = null, $outId = null, $smsUpExtendCode = null)
    {
        ...
        // 必填，设置签名名称
        $request->setSignName("MealPlan饮食计划");

        // 必填，设置模板CODE
        $request->setTemplateCode("SMS_109400313");
